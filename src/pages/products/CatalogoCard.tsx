...
const productData: Category[] = [
    {
        name: "PROTEÍNA",
        products: [
            { id: 1, image: "assets/prote-1.png", title: "STAR NUTRITION WHEY ISOLATE", description: "Proteína de alta calidad.", price: "$32000" },
            { id: 2, image: "assets/prote-1.png", title: "STAR NUTRITION PLATINUM DOYPACK", description: "Proteína avanzada.", price: "$57000" },
            { id: 3, image: "assets/prote-1.png", title: "ENA TRUE MADE", description: "Ideal para recuperación.", price: "$36300" },
            { id: 4, image: "assets/prote-1.png", title: "PROTEINA WHEY ADVANCED XTRENGHT", description: "Para entrenamientos intensos.", price: "$29800" }
        ]
    },
    {
        name: "CREATINA",
        products: [
            ...
            { id: 6, image: "assets/creatina-1.png", title: "MAXI GAIN GENTECH", description: "Gana masa muscular.", price: "$28200" },
            { id: 7, image: "assets/creatina-1.png", title: "NITROGAIN XTRENGHT", description: "Fuerza y resistencia.", price: "$27500" },
            { id: 8, image: "assets/creatina-1.png", title: "CREATINA STAR NUTRITION DOYPACK", description: "Alta pureza.", price: "$20000" }
        ]
    }
];
